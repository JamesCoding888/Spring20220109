...
public class Audience {
	// 切面表達式可以指向 interface 
	@Before("execution(public void com.study.spring2.case05.aop_dancer.Performance.perform(..))")
	...
	@AfterReturning("execution(public void com.study.spring2.case05.aop_dancer.Performance.perform(..))")
	public void applause() {
		System.out.println("返回通知 - 拍手鼓掌");
	}
	@AfterThrowing("execution(public void com.study.spring2.case05.aop_dancer.Performance.perform(..))")
